...
# ============================================================================
# Hybrid Wine/Neutron Installer  —  looni edition
# ============================================================================
...
do_uninstall() {
  ...
  if [ -z "$name" ]; then
    read -rp "  Tool name to uninstall [wine-neutron_looni]: " name
    name="${name:-wine-neutron_looni}"
  fi
...
${C_BOLD}Hybrid Wine/Neutron Installer  —  looni edition  v${VERSION}${C_RESET}
...
printf '  ╔══════════════════════════════════════════════════════════════╗\n'
printf '  ║                                                              ║\n'
printf '  ║  🍷  Hybrid Wine/Neutron Installer  —  looni edition          ║\n'
...
if [ -n "$CLI_TOOL_NAME" ]; then
  ...
  read -rp "  Tool name [wine-neutron_looni]: " TOOL_NAME
  TOOL_NAME="${TOOL_NAME:-wine-neutron_looni}"
fi
...
# Generated by wine-neutron_looni-unified.sh v${VERSION}
