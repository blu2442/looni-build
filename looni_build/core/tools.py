"""Catalogue of looni-build tools surfaced by the launcher.
...
Ordering here matches the order shown in the legacy ``looni-build.sh`` menu,
...
class Tool:
    ...
    source_relpath: str
    """Path to the shell script, relative to the looni-build repo root."""
...
TOOLS: Final[tuple[Tool, ...]] = (
    Tool(
        ...
        group="build",
        source_relpath="looni-wine_builder/wine-builder.sh",
    ),
    Tool(
        key="neutron-builder",
        icon="🎮",
        ...
        group="build",
        source_relpath="looni-neutron_builder/neutron-builder.sh",
    ),
    Tool(
        key="proton-builder",
        icon="🔧",
        ...
        group="build",
        source_relpath="looni-proton_builder/proton-builder.sh",
        installed_lib_subdir="looni-proton_builder",
    ),
    Tool(
        ...
        group="hybrid",
        source_relpath="looni-wine-proton_hybrid_builder/wine-proton_hybrid-v1.0.0.sh",
    ),
    Tool(
        ...
        group="hybrid",
        source_relpath="looni-wine-neutron_hybrid_builder/wine-neutron_hybrid-v1.0.0.sh",
    ),
    Tool(
        ...
        group="install",
        source_relpath="looni-winetoolz/modules/shared_lib/wine_install_manager.sh",
        installed_lib_subdir="looni-winetoolz/modules/shared_lib",
    ),
    Tool(
        key="neutron-install",
        icon="🚀",
        ...
        group="install",
        source_relpath="looni-neutron-install/neutron-install.sh",
        installed_lib_subdir="looni-neutron-install",
    ),
    Tool(
        key="proton-install",
        icon="🛸",
        ...
        group="install",
        source_relpath="looni-proton-install/proton-install.sh",
        installed_lib_subdir="looni-proton-install",
    ),
    Tool(
        key="wine_toolz",
        icon="🧰",
        ...
        group="gui",
        source_relpath="looni-winetoolz/wine_toolz.sh",
        installed_lib_subdir="looni-winetoolz",
    ),
)
...
def get_tool(key: str) -> Tool:
    ...
    try:
        ...
        raise KeyError(f"Unknown looni-build tool: {key!r}") from e
