"""Tkinter GUI frontend for looni-build.
...
from looni_build.core import TOOLS, find_tool
...
class LooniGui:
    ...
    def _build_ui(self) -> None:
        # Header
        header = ttk.Label(self.root, text="🐺  looni-build", style="Header.TLabel")
